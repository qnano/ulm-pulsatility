...
% Latest update by Myrthe Wiersma on 2022/11/22

% This script takes 3 input data set corresponding to lateral locations 
...
Data_folder = 'C:\Users\Lab3\Documents\DataSets';                            % Change this to the location of the DataSets folder on your pc
Folders = cell(3,1);
...
if (R==1)&&(TRACK==1)
    %load([ main_folder filesep  'Track_r1_illustration.mat'])
    subplot(3,4,1)
    hold on
    %plot(Track_r1_illustration(:,2)*lambda*1000,Track_r1_illustration(:,1)*lambda*1000,'Color', [0.36,0.27,0.88], 'DisplayName', 'R1')
...
if (R==2)&&(TRACK==4)
    %load([ main_folder filesep 'Track_r2_illustration.mat'])
    subplot(3,4,1)
    hold on
    %plot(Track_r2_illustration(:,2)*lambda*1000,Track_r2_illustration(:,1)*lambda*1000,  'Color', [0.07,0.62,1.00], 'DisplayName', 'R2')
    plot(Track_tot_raw{TRACK,1}(:,2)*lambda*1000,Track_tot_raw{TRACK,1}(:,1)*lambda*1000,  'Color', [0.07,0.62,1.00], 'DisplayName', 'R2')
...
if (R==3)&&(TRACK==10)
    %load([ main_folder filesep 'Track_r3_illustration.mat'])
    subplot(3,4,1)
    hold on
    %plot(Track_r3_illustration(:,2)*lambda*1000,Track_r3_illustration(:,1)*lambda*1000,  'Color', [1,0,0], 'DisplayName', 'R3')
...
% figure
% for i =1:size(Track_tot_raw,1)
%     if i ==1
%         plot(Track_tot_raw{i,1}(:,2)*lambda*1000,Track_tot_raw{i,1}(:,1)*lambda*1000, 'Color', [0.7,0.7,0.7], 'DisplayName', 'ULM tracks')
%     else
%         plot(Track_tot_raw{i,1}(:,2)*lambda*1000,Track_tot_raw{i,1}(:,1)*lambda*1000, 'Color', [0.7,0.7,0.7],  'HandleVisibility', 'Off')
% 
%     end
%     hold on
% end
...
%    end
% end
% for folder = 1:length(main_folders)
% plot(Track_folder{folder,1}(:,2),Track_folder{folder,1}(:,1))
% end
% hold on
% 
% axis('equal')
...
%clear Localizations Track_tot Track_tot_raw P_f_values 
